# `iceberg_rust_ffi_jll.jl` (v0.7.19+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/a6a5e0b580fed0a118cf04f0f05bab4c6ef18845/I/iceberg_rust_ffi/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/RelationalAI/RustyIceberg.jl.git (revision: `2b4d634de6fea599a8a3bebe78388efb2a48d197`)
