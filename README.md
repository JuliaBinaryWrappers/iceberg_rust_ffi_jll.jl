# `iceberg_rust_ffi_jll.jl` (v0.7.5+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/08a5109da3ab220514c1e97ad625d3258fdabfbe/I/iceberg_rust_ffi/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/RelationalAI/RustyIceberg.jl.git (revision: `853e61aad2ea7df4394300bad0a6c49e12eb49bd`)
