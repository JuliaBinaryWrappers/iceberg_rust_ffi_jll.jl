# `iceberg_rust_ffi_jll.jl` (v0.7.16+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/24a7e24485391df27f10a7bc7ec5482202342e94/I/iceberg_rust_ffi/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/RelationalAI/RustyIceberg.jl.git (revision: `cdce4729628136f2bd094f26d292e374d14fe41f`)
