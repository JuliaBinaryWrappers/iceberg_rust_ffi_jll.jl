# `iceberg_rust_ffi_jll.jl` (v0.7.17+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/5d9e5bb83fe2daea9e4b9083d2b7f726e318062a/I/iceberg_rust_ffi/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/RelationalAI/RustyIceberg.jl.git (revision: `8d47d90714682b93c1f56fe9676d27004fcbccb0`)
