# `iceberg_rust_ffi_jll.jl` (v0.7.20+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/30e8e04c39a982e3bf3f956638184447ae84a204/I/iceberg_rust_ffi/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/RelationalAI/RustyIceberg.jl.git (revision: `05165e3193b20e890043534393fdb9e32989f5d5`)
