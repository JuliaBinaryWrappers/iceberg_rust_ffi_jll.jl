# `iceberg_rust_ffi_jll.jl` (v0.7.18+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/bc59f725623f3640cac2192e1f57c6a07324b3b1/I/iceberg_rust_ffi/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/RelationalAI/RustyIceberg.jl.git (revision: `cc6993967764c22ebf049b23f9aeb0bf512bce79`)
